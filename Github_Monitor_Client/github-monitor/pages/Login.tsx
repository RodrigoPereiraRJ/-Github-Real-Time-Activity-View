      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <Button variant="ghost" className="w-full font-bold border border-border text-txt-main hover:bg-black/5 dark:hover:bg-white/10 focus:ring-0 focus:ring-offset-0 focus:outline-none" disabled={loading}>
